          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-xs">
              ...
              <dl className="mt-3 space-y-2 text-xs">
                ...
                <div className="flex justify-between gap-3"><dt className="text-slate-500">Gateway probe</dt><dd className="font-bold text-slate-800">{displayValue(wifi?.gatewayProbeMethod)}{wifi?.gatewayLatencyMs !== undefined && wifi?.gatewayLatencyMs !== null ? ` · ${wifi.gatewayLatencyMs} ms` : ''}</dd></div>
                ...
                <div className="flex justify-between gap-3"><dt className="text-slate-500">DNS response</dt><dd className="font-bold text-slate-800">{displayValue(wifi?.dnsResponseTimeMs, wifi?.dnsResponseTimeMs === undefined || wifi?.dnsResponseTimeMs === null ? '' : ' ms')}</dd></div>
